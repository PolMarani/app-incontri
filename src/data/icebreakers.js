...
export const FAMILY_PROMPTS = {
  outdoor: [
    'Vi piace stare fuori: qual e la volta che siete tornati più conciati da un posto, e ne e valsa la pena?',
  ...
  lettura: [
    'Il libro che avete abbandonato a meta senza sensi di colpa e perché.',
  ...
  schermo: [
    ...
    'Serie perfetta rovinata dall\'ultima stagione: chi ha l esempio più doloroso?',
  ],
  cucina: [
    'Entrambi vi occupate di {interesse}: la cosa più strana che avete mangiato e rifareste?',
  ...
  arte: [
    ...
    'La cosa più brutta che vi piace davvero.',
  ],
  tech: [
    ...
    'Chi dei due sopravviverebbe più a lungo senza telefono, e chi sta bluffando?',
  ],
  giochi: [
    'Entrambi giocate: siete più da alleanza tradita all\'ultimo turno o da vittoria pulita e noiosa?',
    'Il gioco che avete smesso di proporre agli amici perché rovinava le serate.',
  ...
  animali: [
    ...
    'Su {interesse}: il comportamento animale che vi sembra più intelligente di meta delle persone che conoscete.',
    'Chi dei due si ferma più spesso per strada a salutare un cane?',
  ],
  viaggi: [
    'Entrambi viaggiate: la cosa più strana che avete mangiato in viaggio?',
    ...
    'Zaino e nessun piano o tutto prenotato tre mesi prima: chi di voi due dura di più con il metodo dell\'altro?',
  ],
  pensiero: [
  ...
  sociale: [
    ...
    'La cosa più utile che avete fatto per il vostro quartiere, anche minuscola.',
  ],
  collezioni: [
    'Su {interesse}: il pezzo che non vendereste mai e quello che avete pagato troppo.',
    'Quando una passione diventa accumulo? Chi dei due e più vicino al confine?',
    'Fate vedere una foto della cosa più assurda che possedete.',
  ],
};
...
export const GENERIC_INTEREST_PROMPTS = [
  ...
  'Qual e l errore da principiante che avete fatto più a lungo con {interesse}?',
];
...
export const DIVERGENCE_PROMPTS = [
  ...
  'Se doveste passare un sabato intero facendo {interesse}, cosa vi spaventa di più?',
  'Chi ha nominato {interesse} deve dire la cosa più noiosa che comporta, onestamente.',
];
...
export const CURIOSITY_PROMPTS = [
  ...
  '"{curiosita}" e la cosa più strana emersa stasera. L\'altro può fare tre domande, una alla volta.',
];
...
export const VENUE_PROMPTS = {
  caffe_tranquillo: [
    'Scegliete un tavolo che non è il vostro e inventate cosa si stanno dicendo. Poi confrontate le versioni.',
    'Ordinate a testa quello che pensate piacerebbe all\'altro e vedete chi ha sbagliato di più.',
  ],
  libreria: [
  ...
  bar_serale: [
    'Guardatevi intorno e scegliete la persona con la storia più improbabile. Costruitela insieme.',
    'Ognuno ordina qualcosa che non ha mai provato. Chi fa la faccia peggiore paga il prossimo giro.',
  ],
  aperitivo: [
    'Dividetevi il piatto peggiore del buffet e decretate chi ha avuto la parte più ingiusta.',
    'Un aperitivo dice molto di una città: cosa direbbe questo posto di Milano a uno straniero?',
  ],
  parco: [
    'Camminate finché uno dei due non trova qualcosa che merita di essere fotografata. Chi cede per primo?',
    'Scegliete un albero e decidete a quale dei due assomiglia di più, con motivazione.',
  ],
  passeggiata: [
    'Regola: si gira a destra a ogni incrocio per quattro incroci. Dove siete finiti?',
    'Ognuno indica un palazzo in cui non vivrebbe mai e spiega perché.',
  ],
  museo: [
    'Ognuno sceglie l\'opera che appenderebbe in cucina. Nessuna scelta seria ammessa.',
    'Trovate insieme il quadro con la faccia più antipatica e datele un nome.',
  ],
  mostra: [
    'Inventate la didascalia di un opera senza leggere quella vera, poi controllate quanto vi siete allontanati.',
    'Chi dei due dura di più davanti a una sola opera senza tirare fuori il telefono?',
  ],
  mercato: [
    'Budget di cinque euro a testa: comprate la cosa più strana e ve la dividete.',
  ...
  concerto_piccolo: [
    'Prima che inizi: scommettete su quanti pezzi durerà prima che uno dei due dica "questo lo conosco".',
...
export const UNIVERSAL_DECK = [
  { categoria: 'dilemma', testo: 'Chi di voi due sopravviverebbe più a lungo su un\'isola deserta, e perché l\'altro si sbaglia?' },
  ...
  { categoria: 'dilemma', testo: 'Vi tolgono per sempre la musica o per sempre i libri: chi decide più in fretta?' },
  ...
  { categoria: 'ipotetico', testo: 'Avete un annuncio da leggere a tutta la città, dieci secondi. Cosa dite?' },
  ...
  { categoria: 'opinione_impopolare', testo: 'La regola sociale più inutile che continuate a rispettare comunque.' },
  { categoria: 'opinione_impopolare', testo: 'Un classico intoccabile che secondo voi non regge più: nominatelo e preparatevi a difenderlo.' },
  { categoria: 'opinione_impopolare', testo: 'Qualcosa di universalmente considerato rilassante che a voi mette ansia.' },
  { categoria: 'abitudini', testo: 'La cosa più strana che fate quando siete soli in casa e che non avete mai raccontato.' },
  ...
  { categoria: 'abitudini', testo: 'Su cosa spendete più di quanto ammettereste in pubblico?' },
  { categoria: 'abitudini', testo: 'La bugia piccolissima che dite più spesso.' },
  { categoria: 'abitudini', testo: 'Come vi comportate davvero quando siete in ritardo: accelerate o vi arrendete?' },
  { categoria: 'retrospettiva', testo: 'La decisione presa in meno di un minuto che ha cambiato più cose.' },
  { categoria: 'retrospettiva', testo: 'Una cosa che a vent anni vi sembrava fondamentale e oggi non riuscite nemmeno a ricordare perché.' },
  { categoria: 'retrospettiva', testo: 'Il complimento più strano che vi abbiano fatto e che vi e rimasto addosso.' },
  { categoria: 'retrospettiva', testo: 'La cosa più coraggiosa che avete fatto e che a nessuno e sembrata coraggiosa.' },
  { categoria: 'retrospettiva', testo: 'Un consiglio che avete ignorato e avevate ragione a ignorare.' },
  { categoria: 'gioco', testo: 'Due verità e una bugia, ma solo su cose successe questa settimana.' },
